...
final class DomainsService extends AbstractService
{
    ...
    public function get(string $domain, ?string $xShopperId = null, ?string $customerId = null, ?string $xRequestId = null, ?array $includes = null): mixed
    {
        if ($customerId !== null) {
    ...
    public function updateContacts(string $domain, array $contacts, ?string $xShopperId = null, ?string $customerId = null, ?string $xRequestId = null): mixed
    {
        if ($customerId !== null) {
            return $this->call('PATCH', '/v2/customers/{customerId}/domains/{domain}/contacts', pathParams: compact('customerId', 'domain'), headers: ['X-Request-Id' => $xRequestId], body: $contacts);
        }
    ...
    public function renew(string $domain, ?string $xShopperId = null, ?array $body = null, ?string $customerId = null, ?string $xRequestId = null): mixed
    {
        if ($customerId !== null) {
    ...
    public function cancelChangeOfRegistrant(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function getChangeOfRegistrant(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function addDnssecRecords(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function removeDnssecRecords(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function replaceNameServers(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function getPrivacyForwarding(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function updatePrivacyForwarding(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function redeem(string $customerId, string $domain, ?string $xRequestId = null, ?array $body = null): mixed
    {
    ...
    public function transfer(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function getTransfer(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function validateTransfer(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function acceptTransferIn(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function cancelTransferIn(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function restartTransferIn(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function retryTransferIn(string $customerId, string $domain, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function transferOut(string $customerId, string $domain, string $registrar, ?string $xRequestId = null): mixed
    {
    ...
    public function acceptTransferOut(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function rejectTransferOut(string $customerId, string $domain, ?string $xRequestId = null, ?string $reason = null): mixed
    {
    ...
    public function getActions(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
    ...
    public function cancelAction(string $customerId, string $domain, string $type, ?string $xRequestId = null): mixed
    {
    ...
    public function getAction(string $customerId, string $domain, string $type, ?string $xRequestId = null): mixed
    {
    ...
    public function getNotifications(string $customerId, ?string $xRequestId = null): mixed
    {
    ...
    public function getNotificationOptIn(string $customerId, ?string $xRequestId = null): mixed
    {
    ...
    public function updateNotificationOptIn(string $customerId, array $types, ?string $xRequestId = null): mixed
    {
    ...
    public function getNotificationSchema(string $customerId, string $type, ?string $xRequestId = null): mixed
    {
    ...
    public function acknowledgeNotification(string $customerId, string $notificationId, ?string $xRequestId = null): mixed
    {
    ...
    public function register(string $customerId, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function registerSchema(string $customerId, string $tld, ?string $xRequestId = null): mixed
    {
    ...
    public function validateRegistration(string $customerId, array $body, ?string $xRequestId = null): mixed
    {
    ...
    public function listMaintenances(?string $xRequestId = null, ?string $status = null, ?string $modifiedAtAfter = null, ?string $startsAtAfter = null, ?int $limit = null): mixed
    {
    ...
    public function getMaintenance(string $maintenanceId, ?string $xRequestId = null): mixed
    {
    ...
    public function getUsage(string $yyyymm, ?string $xRequestId = null, ?array $includes = null): mixed
    {
    ...
    public function regenerateAuthCode(string $customerId, string $domain, ?string $xRequestId = null): mixed
    {
